<template>
  <div class="userLayout">
    ...
    <router-view />
    <div class="footer">
      <p><span class="marginR25">Ant Design Pro</span><span class="marginL25">Ant Design</span></p>
      <p>Copyright©2019 蚂蚁金服体验技术部出品</p>
    </div>
  </div>
</template>
<style scoped>
...
.footer{text-align: center;line-height:30px;padding:0 0 30px 0;}
</style>